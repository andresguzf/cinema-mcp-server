...
public class CinemaCatalogRepository {
    ...
    /**
     * Obtiene la lista completa e inmutable de películas en cartelera.
     *
     * @return Lista inmutable de objetos Movie.
     */
    ...
    /**
     * Busca películas por coincidencia parcial en el título (ignorando mayúsculas/minúsculas).
     *
    ...
    /**
     * Busca una película por su título exacto o más cercano.
     *
     * @param title Título exacto.
     * @return Optional con la película encontrada.
     */
